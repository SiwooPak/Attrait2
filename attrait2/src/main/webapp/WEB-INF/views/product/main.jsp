...
<c:set var="officeUrl">${context}/product/retrieveProductList?category=${dsProductList[0].PRODUCT_CATEGORY_CD}</c:set>
<c:set var="penUrl">${context}/product/retrieveProductList?category=${dsProductList[1].PRODUCT_CATEGORY_CD}</c:set>
<c:set var="binderUrl">${context}/product/retrieveProductList?category=${dsProductList[2].PRODUCT_CATEGORY_CD}</c:set>
<c:set var="designUrl">${context}/product/retrieveProductList?category=${dsProductList[3].PRODUCT_CATEGORY_CD}</c:set>
<c:set var="storageUrl">${context}/product/retrieveProductList?category=${dsProductList[4].PRODUCT_CATEGORY_CD}</c:set>

<c:set var="productManageUrl">${context}/product/retrieveProductListForManage</c:set>
<c:set var="statisticsForProductUrl">${context}/sell/retrieveStatisticsForProduct</c:set>
<c:set var="statisticsForStockUrl">${context}/product/retrieveStatisticsForStock?productCategoryCd=P</c:set>
