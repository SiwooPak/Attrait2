...
<head>
    ...
    function fn_buy(){
		location.href = "${context}/sell/createSell?productCode=" + '${dsProduct.PRODUCT_CODE}' + "&sellPrice=" + priceTotal + "&sellCount=" + stockTotal;
    }

	function fn_cart(){
		location.href = "${context}/cart/createCart?productCode=" + '${dsProduct.PRODUCT_CODE}' + "&cartPrice=" + priceTotal + "&cartCount=" + stockTotal;
    }
	...
	function fn_remove(paramUserReplyNo){
		...
		if(confirm("정말 삭제하시겠습니까?")){
			location.href = "${context}/reply/deleteReply?userReplyNo=" + userReplyNo + "&productCode=" + productCode;
		}
	}
			...
			<div class="col-md-12">
		    	<div class="well well-sm">
		            ...
		            <div class="row" id="post-review-box" style="display:none;">
		                <div class="col-md-12">
		                    <form id="createReply" accept-charset="UTF-8" action="${context}/reply/createReply" method="post">
