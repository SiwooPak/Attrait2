...
<head>
    ...
    <link href="${context}/common/css/morris.css" rel="stylesheet">
    ...
    <script src="${context}/common/js/morris.min.js"></script>
    <script src="${context}/common/js/raphael.js"></script>
    ...
    $(document).ready(function(){
    	...
    	$("#sort").change(function(){
    		...
    		if(sort == 'stockP'){
				url = "${context}/product/retrieveStatisticsForStock?productCategoryCd=P";
    		}else if(sort == 'stockO'){
				url = "${context}/product/retrieveStatisticsForStock?productCategoryCd=O";
    		}else if(sort == 'stockS'){
				url = "${context}/product/retrieveStatisticsForStock?productCategoryCd=S";
    		}else if(sort == 'stockB'){
				url = "${context}/product/retrieveStatisticsForStock?productCategoryCd=B";
    		}else if(sort == 'stockD'){
				url = "${context}/product/retrieveStatisticsForStocko?productCategoryCd=D";
    		}else if(sort == 'sell'){
    			url = "${context}/product/retrieveStatisticsForSell";
    		}
