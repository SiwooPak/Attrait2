...
<head>
    ...
    $(document).ready(function(){
    	...
    	$("#sort").change(function(){
    		...
    		if(sort == 'product'){
				url = "${context}/sell/retrieveStatisticsForProduct";
    		}else if(sort == 'category'){
    			url = "${context}/sell/retrieveStatisticsForCategory";
    		}
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-1 col-md-offset-11">
				<button type="button" class="btn btn-success btn-lg"  style="float:right;" onclick="location.href='./goMain'">뒤로가기</button>
			</div>
		</div>
